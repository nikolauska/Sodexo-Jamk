...
public class LanguageHandler {
	...
	// Settings Locations
	private CharSequence[] SettingsFinnishLocation = {"Dynamo", "Pääkampus", "Rajacafé", "Musiikkikampus"};
	private CharSequence[] SettingsEnglishLocation = {"Dynamo", "Main Campus", "Rajacafé", "Music Campus"};
	...
	private String[] RajaCafe = {"Rajacafé", "Rajacafé"};
